...
export default function BuyerDashboard() {
  ...
  const fetchNotificationCount = async () => {
    try {
      ...
      setBuyerCompanyName(userData.user.companyName || "Transport Company")
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div>
                <h1 className="text-2xl font-bold text-foreground">{buyerCompanyName || "Buyer Dashboard"}</h1>
                <p className="text-sm text-muted-foreground">Welcome back to {buyerCompanyName || "your company"}</p>
              </div>
            </div>
