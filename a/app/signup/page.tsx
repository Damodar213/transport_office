                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="supplier-mobile" name="mobile" type="tel" required placeholder="Enter mobile number" />
                    </div>
                  </div>
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="admin-mobile" name="mobile" type="tel" required placeholder="Enter mobile number" />
                    </div>
                  </div>
