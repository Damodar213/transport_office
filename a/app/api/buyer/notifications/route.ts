...
// Format timestamp function with proper IST handling - Buyer panel shows only date and time
function formatTimestamp(timestamp: string | Date): string {
  try {
    ...
    // For buyer panel, always show only the formatted date and time (no relative time)
