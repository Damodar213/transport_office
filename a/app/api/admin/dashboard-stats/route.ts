  ...
  try {
    ...
    if (!getPool()) {
      ...
      const mockStats = {
        ...
        systemHealth: {
          databasePerformance: { value: 92, label: "Database Performance" },
          apiResponseTime: { value: 85, label: "API Response Time" },
          storageUsage: { value: 67, label: "Storage Usage" },
          userActivity: { value: 94, label: "User Activity" }
        },
        recentActivities: [],
        todaySummary: {
          newRegistrations: 0,
