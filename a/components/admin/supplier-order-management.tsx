...
import { capitalizeName, capitalizeWords, capitalizePlace } from "@/lib/name-utils"
                  ...
                  <TableRow key={order.id}>
                    <TableCell>
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">{capitalizeName(order.supplier_name)}</div>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="flex items-center gap-1">
                        ...
                        <div className="text-sm">
                          <div className="font-medium">{capitalizePlace(order.place)}, {capitalizePlace(order.district)}</div>
                          <div className="text-muted-foreground">{capitalizePlace(order.state)}</div>
