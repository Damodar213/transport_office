...
import { capitalizeName, capitalizeWords, formatDocumentType } from "@/lib/name-utils"
                  ...
                  <TableRow key={document.id} className="bg-background/50">
                    <TableCell>
                      <div className="pl-6">
                        ...
                        {document.driverName && (
                          <div className="text-sm text-blue-600">Driver: {capitalizeName(document.driverName)}</div>
                        )}
